...
def run_test_zero_changer():
    ...
    # -------------------------------------------------------------------------
    # Test 2:
    test1 = ([8, 4, 0, 0], [0, 0, 0, 1, 0, 0], [4, 0, 4], [4, 0, 4])
    expected1 = ([8, 4, 1, 2], [3, 4, 5, 1, 6, 7], [4, 8, 4], [4, 9, 4])
    zero_changer(test1)
    print()
    print('Test 1:')
    print('  Expected:', expected1)
    ...
    # Test 3:
    test1 = ([8, 4, 9], [77, 1, 5], [4, 4, 4], [4, 99, 4])
    expected1 = ([8, 4, 9], [77, 1, 5], [4, 4, 4], [4, 99, 4])
    zero_changer(test1)
    print()
    print('Test 1:')
    print('  Expected:', expected1)
